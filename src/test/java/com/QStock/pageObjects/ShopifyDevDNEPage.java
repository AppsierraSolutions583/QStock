...
public class ShopifyDevDNEPage extends GeneralFunctions {
	public WebDriver driver;
	public static Logger log = Logger.getLogger(ShopifyDevDNEPage.class);
	...
	@FindBy(xpath = "//ul[@class='treeview-menu menu-open']//a[contains(text(),'Shopify Dev Does Not exist')]")
	private WebElement shopifyDevMenu;
	...
	public ShopifyDevDNEPage(WebDriver driver) {
		this.driver = driver;
