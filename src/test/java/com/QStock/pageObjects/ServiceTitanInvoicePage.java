...
public class ServiceTitanInvoicePage extends GeneralFunctions {

	public WebDriver driver;
	public static Logger log = Logger.getLogger(ServiceTitanInvoicePage.class);

	@FindBy(xpath = "//a[text()='Order Management ']")
	private WebElement orderManagement;

	@FindBy(xpath = "//a[contains(text(),'ServiceTitan Invoices')]")
	...
	public ServiceTitanInvoicePage(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}

	public boolean goToServiceTitan() {
		boolean flag = false;
		click(orderManagement);
		click(ServiceTitan);

		flag = driver.getCurrentUrl().contains("OrderManager");
		log.info("landed on Order Manager Page.");
		return flag;
	}
