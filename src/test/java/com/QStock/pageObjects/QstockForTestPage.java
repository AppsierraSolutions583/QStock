...
public class QstockForTestPage extends GeneralFunctions {
	public WebDriver driver;
	public static Logger log = Logger.getLogger(QstockForTestPage.class);
	...
	@FindBy(xpath = "//ul[@class='treeview-menu menu-open']//a[contains(text(),'QStock for Test')]")
	private WebElement qstockforTestMenu;
	...
	public QstockForTestPage(WebDriver driver) {
		this.driver = driver;
	...
	public void ActivitySearchAndDetailErrorTab() {
		...
		sendKeys(date,"12/1/2022 9:44:57 AM PST");		
		try {
			Thread.sleep(6000L);
		} catch (InterruptedException e) {
			e.printStackTrace();
