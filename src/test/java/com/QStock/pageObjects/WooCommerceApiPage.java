...
public class WooCommerceApiPage extends GeneralFunctions
{
	public WebDriver driver;
	public static Logger log = Logger.getLogger(LoginPage.class);

	public WooCommerceApiPage(WebDriver driver) 
	{
		this.driver = driver;
	...
	@FindBy(xpath = "(//a[text()='WooCommerce-API'])[1]")
	private WebElement wooCommerceApi;
	...
	public boolean wooCommerceApiConfirm()
	{
		click(dashBoard);
		click(wooCommerceApi);
		...
		boolean check = collectText(panelHeading).contains("WooCommerce-API");
		return check;	
	}
